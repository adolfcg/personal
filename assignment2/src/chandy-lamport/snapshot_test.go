...
func runTest(t *testing.T, topFile string, eventsFile string, snapFiles []string) {
	...
	// Here just read the topology, we will start to load the events described in the event file
	// Events like snapshot N2*
	...
	// Optionally print events for debugging (i dont know yet how debug)
	if debug {
